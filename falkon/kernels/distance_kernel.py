...
class L2DistanceKernel(Kernel, ABC):
    ...
    L2-distance kernels are characterized by the squared norm of the difference between each input
...
class LaplacianKernel(L2DistanceKernel):
...
class MaternKernel(L2DistanceKernel):
